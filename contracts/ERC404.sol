...
abstract contract ERC404 is Ownable {
    ...
    function _mint(address to) internal virtual {
        ...
        //to know owner from id
        _ownerOf[id] = to;
        //to get all id of an owner(only referencing)
        _owned[to].push(id);
        //location to store the id(actually storing-global event not per account)
    ...
    function _burn(address from) internal virtual {
        ...
        //finding the last id to burn from the end
